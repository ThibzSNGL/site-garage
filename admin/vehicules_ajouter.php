...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if (
    ...
    } elseif (!ctype_digit($annee) || (int)$annee < 1950 || (int)$annee > (int)date('Y') + 1) {
        $message_error = "L'année du véhicule n'est pas valide.";
    } elseif (!ctype_digit($kilometrage) || (int)$kilometrage < 0) {
        ...
        if (empty($message_error)) {
            ...
            $message_success = "Le véhicule a bien été ajouté.";
...
<main class="admin-main">
    <header class="admin-topbar">
        <div>
            ...
            <p>Ajoutez un nouveau véhicule à afficher sur la page vitrine.</p>
        </div>
    ...
    <section class="admin-panel">
        ...
        >
            ...
            <div class="admin-form-actions">
                <button type="submit" class="admin-save-btn">Ajouter le véhicule</button>
